...
p. Rah_change_password will add extra options to the "Users":http://textpattern.net/wiki/index.php?title=Users panel's editor. When logged in as a "Publisher":http://textpattern.net/wiki/index.php?title=User_Roles_and_Permissions, you will see options to change the password when editing any user account. These added extra options include way to reset login session for others, to change and optionally email passwords.
...
* Changed: Integrated with the User Editor located at the Users panel.
